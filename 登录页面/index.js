var userLandContaner = document.getElementsByClassName('userLand_contaner')[0],    //扫码登录页面
    accountEntry = document.getElementsByClassName('accountEntry')[0],     //账号密码登录页面
    SweepCodeEntry = document.querySelector('#SweepCodeEntry'), //扫码登录按钮
    accountNumberEntry = document.querySelector('#accountNumberEntry'), //账号登录按钮
    accountEntryInput = accountEntry.getElementsByTagName('input'),        //密码输入框与账号输入框
    userremove = accountEntry.getElementsByClassName('userremove'),     //取消按钮
    mask = document.getElementsByClassName('mask')[0],                 //蒙层方便进行js操作
    QRCode = document.getElementsByClassName('QRCode')[0],              //两个页面的dom元素
    explain = document.getElementsByClassName('explain')[0],        //两个页面的dom元素
    submit = document.querySelector('#submit'),            //提交按钮
    userNumber = document.querySelector('#userNumber'),     //账号框
    userPassword = document.querySelector('#userPassword'),     //密码框
    passwordWrong = document.querySelector('.passwordWrong'),
    userOrPassword = [["付志国", 777], ["邓志鹏", 777], ["鹏鹏", 000], ["谭炜", 223], ["廖辉", "888"]];
...
(function(){
    ...
    proving = document.querySelector('.accountEntry .proving');     //验证这一整块
